...
public class WebLogAspect {
    ...
    @Before("execution(* io.communet.fileser.web.controller..*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value = "execution(* io.communet.fileser.web.controller..*(..)) or execution(* io.communet.fileser.web.exception..*(..))",returning = "reponse")
